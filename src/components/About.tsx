        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              Since 1985, Vistaria has been a cornerstone of fine dining, where traditional recipes 
          ...
          <div className="grid md:grid-cols-2 gap-12 mb-16">
            <div className="space-y-6">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Founded by Chef Marco Benedetti, Vistaria began as a small family restaurant 
            ...
            <div className="space-y-6">
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                guest treated like family. This is the Vistaria way.
              </p>
            </div>
          </div>
