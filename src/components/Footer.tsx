import { MapPin, Phone, Mail, Instagram, Clock, Facebook, Twitter, X } from 'lucide-react';
        ...
        <div className="max-w-6xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="flex items-center space-x-2">
                {/* <div className="w-8 h-8 bg-gradient-gold rounded-full flex items-center justify-center">
                  <span className="text-restaurant-gold-foreground font-bold text-lg">B</span>  for Logo
                </div> */}
                <span className="text-6xl md:text-7xl font-bold" style={{ fontFamily: 'Playfair, serif' }}>Vistaria</span>
              </div>
          ...
          <div className="border-t border-restaurant-cream/20 pt-8 text-center">
            <p className="text-restaurant-cream/60 text-sm">
              © 2024 Vistaria Restaurant. All rights reserved.
            </p>
          </div>
        </div>
      </div>
