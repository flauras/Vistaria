  ...
  return (
    <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center text-white px-4 max-w-4xl mx-auto">
        <h1 className="text-5xl sm:text-7xl md:text-8xl font-bold mb-6 animate-fade-in" style={{ fontFamily: 'Playfair, serif' }}>
          Vistaria
        </h1>
        ...
        <div className="hero-btns flex flex-col sm:flex-row gap-4 justify-center" style={{ width: '60%', margin: '0 auto' }}>
          <Button 
            variant="gold" 
            size="xl"
